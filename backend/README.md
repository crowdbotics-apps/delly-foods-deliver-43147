...
## Project Structure
    ...
    ├── delly_foods_deliver_43147  # Django project configurations
...
1. Clone this repo and `cd delly_foods_deliver_43147`
...
2. Clone this repo and `cd delly_foods_deliver_43147`
