"""
Django settings for delly_foods_deliver_43147 project.
...
ROOT_URLCONF = 'delly_foods_deliver_43147.urls'
...
WSGI_APPLICATION = 'delly_foods_deliver_43147.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delly_foods_deliver_43147 API",
    "DESCRIPTION": "API documentation for delly_foods_deliver_43147 App",
    "VERSION": "v1",
}
